...
def run():
    ...
    # Clear seed.json values to use default values for banking deadlock demo
    db.data = {}
    ...
    log.print_initial_state("balance", db.get_latest("balance"))
    log.print_initial_state("account", db.get_latest("account"))
