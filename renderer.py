# ─────────────────────────────────────
# RENDERER
# All Streamlit UI rendering functions
...
from scenarios import TXN_COLORS, txn_color, ANOMALY_META
from runner import run_isolation_comparison
...
# ─────────────────────────────────────
def inject_css():
    """Inject the full design-token CSS into the Streamlit page."""
    st.markdown("""
<style>
...
# ─────────────────────────────────────
# ISOLATION COMPARISON VIEW
# ─────────────────────────────────────
def render_isolation_comparison(config):
...
# ─────────────────────────────────────
# SCENARIO INTRO + STATS
# ─────────────────────────────────────
def render_scenario_intro(config, result):
...
# ─────────────────────────────────────
def render_step_execution(result):
...
# ─────────────────────────────────────
def render_anomaly_report(result):
...
# TAB 4 — STORAGE & STATE
# ─────────────────────────────────────
def render_storage_state(result):
